...
export function collectContext(root) {
 ...
 const assets = [atlasPath, 'public/models/female-fit-report.json', 'app/anatomy.ts', 'app/anatomy-search.ts', 'app/scene.tsx', 'app/page.tsx', 'app/globals.css', 'web/main.tsx'];
