...
def run(output):
    ...
    filenames = ['report.json'] + [f'{side}-{fit}.npz' for side in ['L', 'R'] for fit in ['translation', 'similarity_icp', 'affine_bounds_diagnostic']]
